...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            app_global_1.ErrorComponent,
            bill_component_1.BillComponent,
            bill_component_1.OrderOrderComponent,
            bill_component_1.BillPayComponent,
            pay_components_1.PayComponent,
            make_component_1.MakeComponent
        ],
        bootstrap: [
            app_global_1.SideSteps,
            app_global_1.Inlay,
