...
@rem ##########################################################################
@rem
@rem  feign-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and FEIGN_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute feign-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEIGN_SERVER_OPTS%  -classpath "%CLASSPATH%" Tutorials.Tutorial_1.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable FEIGN_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%FEIGN_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
